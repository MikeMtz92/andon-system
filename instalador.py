...
class InstaladorAndon:
    ...
    def paso2_5_personalizar_fallas(self):
        """Paso de personalización de tipos de falla"""
        # [El código de personalización de fallas se mantiene igual que en el original]
        # Por brevedad, no replico todo aquí, pero es idéntico al original
        pass
    
    # ===== PASO 3: CONFIRMACIÓN E INSTALACIÓN =====
    def paso3_confirmar_instalacion(self):
        """Confirma e instala el sistema"""
        # [El código de confirmación se mantiene igual que en el original]
        pass
    ...
    def ejecutar_instalacion(self):
        ...
        try:
            ...
            if not exito:
                print(f"    ❌ Error: {msg}")
                messagebox.showerror("Error de Conexión", f"No se puede conectar a MySQL:\n{msg}")
                return
            print("    ✅ Conexión exitosa")
            
            # 2. Verificar/Crear base de datos
            print("\n[2/7] Verificando base de datos...")
            # [El código de verificación de BD se mantiene igual]
